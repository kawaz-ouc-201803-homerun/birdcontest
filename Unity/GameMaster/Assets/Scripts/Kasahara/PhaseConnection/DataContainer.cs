	...
	public void Setup(object[] controllerData) {
		...
		switch(this.OptionA) {
			case (int)PhaseControllers.OptionA.Bomb:
				this.ParamA = (int)(1500f + this.ParamA / (PhaseControllers.ControllerLimitSeconds * 2.0f / 3.0f) * 2000f);
				break;
		...
		switch(this.OptionC) {
			case (int)PhaseControllers.OptionC.Bomb:
				this.ParamC = (int)(500f + this.ParamC / (PhaseControllers.ControllerLimitSeconds * 2.0f / 3.0f) * 750f);
				break;
